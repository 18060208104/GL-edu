package com.feng.educenter.controller;
...
import com.feng.educenter.utils.ConstantWxUtils;
import com.feng.educenter.utils.HttpClientUtils;
...
@CrossOrigin
@Controller //只是请求地址，不返回数据，所以不使用@RestController
